    ...
    #define EEPROM_ADDR_TEMP3_VALUE 8
    #define EEPROM_ADDR_TEMP3_HOURS 9
    #define EEPROM_ADDR_TEMP4_VALUE 10
    #define EEPROM_ADDR_TEMP4_HOURS 11
    #define EEPROM_ADDR_TEMP5_VALUE 12
    #define EEPROM_ADDR_TEMP5_HOURS 13
    #define EEPROM_ADDR_TEMP6_VALUE 14
    #define EEPROM_ADDR_TEMP6_HOURS 15
    #define EEPROM_ADDR_TEMP7_VALUE 16
    #define EEPROM_ADDR_TEMP7_HOURS 17
    #define EEPROM_ADDR_TEMP8_VALUE 18
    #define EEPROM_ADDR_TEMP8_HOURS 19
    #define EEPROM_ADDR_TEMP9_VALUE 20
    #define EEPROM_ADDR_TEMP9_HOURS 21
